            ...
            <div class="col-md-12">
                <div class="form-group">
                   ...
                   <select name="service" id="service" class="form-control">
                    <option value="Implementation of NAPS & NATS" >Implementation of NAPS & NATS</option>
                    <option value="Apprenticeship" >Apprenticeship </option>
                    <option value="HR Services & Compliance" >HR Services & Compliance </option>
                    <option value="POSH Training & Compliance" >POSH Training & Compliance </option>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea id="comments" class="form-control" name="comment" placeholder="Write Message.." required></textarea>
                </div>
            </div>
        </div>
...
document.getElementById("survey-form").addEventListener("submit", function(event) {
  ...
  |   director@vnetpro.in
                    ...
                    <p> <i class="fas fa-home me-3"></i>No-8, 2nd Floor, YRL B. Sardar Basha Tower, Hemavathi Block, Bettadasanapura, Electronic City Phase-1, Bangalore-560100
                    </p>
